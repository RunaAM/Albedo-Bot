...
class Meme(commands.Cog):
	def __init__(self, client):
		self.client = client
	@commands.slash_command(guild_ids=[860869454878736384], name="ale",description="This is for you alec")
	async def ale(self,ctx):
		await ctx.respond("<:emoji_1:871794698887499776> This aint build a bitch u dont get to pick and choose.")
	@commands.slash_command(guild_ids=[860869454878736384], name="runa",description="runa runa runa runa")
	...
	@commands.slash_command(guild_ids=[860869454878736384], name="cimpoi",description="iu iu iu iu iu")
	...
	@commands.slash_command(guild_ids=[860869454878736384], name="chinese",description="i love this")
	async def chinese(self,ctx):
		await ctx.respond("https://www.youtube.com/watch?v=4L-fSsY01TU")
	@commands.slash_command(guild_ids=[860869454878736384], name="pride",description="BEE WHO YOU ARE")
